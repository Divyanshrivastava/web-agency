  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-gray-200 text-4xl font-medium tracking-tight text-transparent"
      >
